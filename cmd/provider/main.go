...
import (
	...
	"github.com/crossplane-contrib/provider-jet-hcloud/config"
	...
	"github.com/crossplane-contrib/provider-jet-hcloud/internal/features"
)
...
func main() {
	...
	kingpin.FatalIfError(controller.Setup(mgr, o), "Cannot setup HCloud controllers")
