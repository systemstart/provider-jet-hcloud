...
export TERRAFORM_PROVIDER_DOWNLOAD_URL_PREFIX := https://github.com/hetznercloud/terraform-provider-hcloud/releases/tag/v1.35.1
export TERRAFORM_NATIVE_PROVIDER_BINARY := terraform-provider-hcloud_v1.35.1
